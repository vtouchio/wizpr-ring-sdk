...
mod tests {
    ...
    #[test]
    fn descriptor_value_uses_notify_when_supported() {
        assert_eq!(
            to_descriptor_value(GattCharacteristicProperties::Notify),
            GattClientCharacteristicConfigurationDescriptorValue::Notify
        );
    }

    #[test]
    fn descriptor_value_uses_notify_when_notify_and_indicate_are_supported() {
        let properties =
            GattCharacteristicProperties::Notify | GattCharacteristicProperties::Indicate;

        assert_eq!(
            to_descriptor_value(properties),
            GattClientCharacteristicConfigurationDescriptorValue::Notify
        );
    }

    #[test]
    fn descriptor_value_ignores_indicate_without_notify() {
        assert_eq!(
            to_descriptor_value(GattCharacteristicProperties::Indicate),
            GattClientCharacteristicConfigurationDescriptorValue::None
        );
    }
}
